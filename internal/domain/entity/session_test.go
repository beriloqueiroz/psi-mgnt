...
func TestValidSession(t *testing.T) {
	...
	session := &Session{ID: "123", Price: 100, Notes: "Session notes", Date: time.Now(), PaymentDate: time.Now(), Duration: 30 * time.Minute, Patient: validPatient, OwnerId: "123"}
	err := session.IsValid()
	if err != nil {
...
func TestInvalidSessionID(t *testing.T) {
	validPatient := &Patient{ID: "12345", Name: "John Doe", Document: "1234567890", Email: "john@example.com", Phones: []Phone{Phone{Value: "123456789", IsChat: true}}}
	session := &Session{Price: 100, Notes: "Session notes", Date: time.Now(), PaymentDate: time.Now(), Duration: 30 * time.Minute, Patient: validPatient, OwnerId: "123"}
	err := session.IsValid()
	if err == nil {
...
func TestInvalidSessionDuration(t *testing.T) {
	validPatient := &Patient{ID: "12345", Name: "John Doe", Document: "1234567890", Email: "john@example.com", Phones: []Phone{Phone{Value: "123456789", IsChat: true}}}
	session := &Session{ID: "123", Price: 100, Notes: "Session notes", Date: time.Now(), PaymentDate: time.Now(), Duration: 0, Patient: validPatient, OwnerId: "123"}
	err := session.IsValid()
	if err == nil {
...
func TestInvalidSessionNotes(t *testing.T) {
	validPatient := &Patient{ID: "12345", Name: "John Doe", Document: "1234567890", Email: "john@example.com", Phones: []Phone{Phone{Value: "123456789", IsChat: true}}}
	session := &Session{ID: "123", Price: 100, Notes: "", Date: time.Now(), PaymentDate: time.Now(), Duration: 10 * time.Minute, Patient: validPatient, OwnerId: "123"}
	err := session.IsValid()
	if err == nil {
